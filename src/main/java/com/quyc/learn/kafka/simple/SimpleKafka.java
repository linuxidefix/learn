package com.quyc.learn.kafka.simple;
...
public class SimpleKafka {
    ...
    private static Map<String, Object> consumerProps() {
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "192.168.199.184:9092");
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "group-simple");
    ...
    private static Map<String, Object> senderProps() {
        Map<String, Object> props = new HashMap<>();
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "192.168.199.184:9092");
